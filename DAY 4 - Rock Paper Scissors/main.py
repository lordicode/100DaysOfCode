...
if sign_index_os == sign_index_player:
    print("It is a draw!\n")
if sign_index_os + sign_index_player > len(signs):
    print("special rules")
elif (sign_index_os > sign_index_player) or (sign_index_player == 14 and sign_index_os <= 6):
    print("You lost!\n")
elif (sign_index_os < sign_index_player) or (sign_index_player != 14 and sign_index_os > 6):
    print("You won!\n")
#else:
...
if you have chosen 14 - wolf, then it beats 13, 12, 11, 10, 9, 8, 7 and is beaten by 0, 1, 2, 3, 4, 5, 6
if you have chosen 13 - sponge, then it beats 12, 11, 10, 9, 8, 7, 6 and is beaten by 14, 0, 1, 2, 3, 4, 5, 6"""
